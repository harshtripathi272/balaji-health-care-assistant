...
def build_supplier_documents():
    ...
    for supplier in suppliers:
        ...
        Supplied Items: {supplier.get("supplied_items")}
        Due amount: {supplier.get("due_amount")}
        """
...
if __name__ == "__main__":
    ...
    if not docs:
        print("❌ No Supplier found. Index not built.")
    else:
        build_suppliers_index(docs)
        print("✅ Suppliers index built and saved.")